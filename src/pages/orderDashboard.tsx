...
const OrderDashboard: React.FC = () => {
  const [showApproveModal, setShowApproveModal] = useState(false);
    ...
    const [orders, setOrders] = useState([
      { id: 1, userId: 1, food: 'Pizza', quantity: 2, totalPrice: 20, status: 'Pending' },
      { id: 2, userId: 2, food: 'Burger', quantity: 1, totalPrice: 10, status: 'Pending' },
      { id: 3, userId: 3, food: 'Pasta', quantity: 3, totalPrice: 30, status: 'Pending' },
